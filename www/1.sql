...
-- Время создания: Авг 04 2012 г., 18:27
...
(63, 'Установка заборов', 3, 47, 48, NULL, 1, 0, NULL, NULL, 'zabory', '', ''),
(64, 'Необычные поздравления в окно', 3, 49, 50, NULL, 1, 0, NULL, NULL, 'pozdravlenija-v-okno', '', ''),
...
(50, 'Монтаж вышек сотовой связи', 3, 69, 70, '2012-07-30 16:56:43', 1, 0, NULL, NULL, 'montazh-vyshek-sotovoj-svjazi', '', ''),
(51, 'Оборудование и датчики', 3, 71, 72, '2012-07-30 16:56:43', 1, 0, NULL, 'b7fee77e6625366b6ff2257e84718301.jpg', 'oborudovanie-i-datchiki', '<p style="text-align: justify;"><br /></p>\r\n<hr />\r\n<p style="text-align: center;"><strong>Промышленная группа &laquo;Альпинисты Москвы&raquo; с радостью выполнит для Вас&nbsp;</strong><br /><strong>самые разнообразные высотные работы. </strong><strong>Спасибо, что выбрали нас!</strong><br /><br />Оценка стоимости конкретного вида работ производится после осмотра объекта.<br />Выезд специалиста на объект (Москва, ближнее Подмосковье) для осмотра и составления сметы<span style="font-size: small;"> &ndash; <strong><span style="font-size: large;">бесплатно!</span></strong></span><strong><em>&nbsp;</em></strong><br /><em>Выезд на объекты, удаленные от Москвы на большие расстояния, осуществляется после дополнительных согласований с Заказчиком.</em></p>', ''),
...
(54, 'Монтаж наружной рекламы', 3, 79, 80, '2012-07-30 16:56:43', 1, 0, NULL, NULL, NULL, '', ''),
(55, 'Установка баннеров', 3, 81, 82, '2012-07-30 16:56:43', 1, 0, NULL, NULL, NULL, '', ''),
(56, 'Световая реклама', 3, 83, 84, '2012-07-30 16:56:43', 1, 0, NULL, NULL, 'svetovaja-reklama', '', ''),
(57, 'Уличная подсветка', 3, 85, 86, '2012-07-30 16:56:43', 1, 0, NULL, NULL, NULL, '', ''),
(58, 'Обустройство выставок и конференций', 3, 87, 88, '2012-07-30 16:56:43', 1, 0, NULL, NULL, NULL, '', ''),
(59, 'Декор помещений', 3, 89, 90, '2012-07-30 16:56:43', 1, 0, NULL, NULL, NULL, '', '');
...
(16, '05.05.2012 Московская областная Дума, мойка фасада', 1, 12, '0000-00-00'),
(17, '11.05.2012 Мойка окон и мойка фасада, Солянка', 1, 13, '0000-00-00'),
...
(7, 'Драйв-очистка от снега', 1, 3, '43d026ff4bcec1b09572833adf00b1d2.jpg'),
(8, 'Драйв-мойка фасада', 1, 4, '3f4fef3737f567bc42ebef463347a237.jpg');
...
(29, 'main', 'news_sidebar_top', 'Верхний сайдбар - Новости', '', 'editor', 0),
(33, 'main', 'prices_sidebar_top', 'Верхний сайдбар - Цены', '', 'textarea', 0),
(31, 'main', 'reviews_sidebar_top', 'Верхний сайдбар - Отзывы', '', 'editor', 0),
(32, 'main', 'gallery_sidebar_top', 'Верхний сайдбар - Галлерея', '', 'editor', 0);
