...
abstract class BaseController extends CController
{
    ...
    {
        if (!in_array($action->id, array('view', 'main')) || $this instanceof AdminController)
        {
            return false;
        }
        ...
        else
        {
            ...
            $val   = $alias ? $alias : ($url ? $url : $id);
            $key   = $alias ? 'alias' : ($url ? 'url' : null);
            $model = $this->loadModel($val, array(), $key);
        }
